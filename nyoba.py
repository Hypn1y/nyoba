...
if menu == "Form Buku Tamu":
    ...
    st.markdown("<h3 style='color: orange;'>Formulir Buku Tamu</h3>", unsafe_allow_html=True)
    ...
    # Scan Wajah
    st.markdown("<h3 style='color: orange;'>Scan Wajah Anda</h3>", unsafe_allow_html=True)
